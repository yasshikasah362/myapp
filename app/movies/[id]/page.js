...
// import { Icon } from "next/dist/lib/metadata/types/metadata-types"; 'remixicon/fonts/remixicon.css'
...
const page = ({ params }) => {
    ...
    const a = Math.floor(detail.vote_average * 10);
    ...
    return <div>
        ...
        <div className={styles.backdiv}>
            ...
            <div className="div" style={{ height: '60vh', width: '20%', position: 'absolute', marginLeft: '80px', marginTop: '20px',overflow: 'hidden', borderRadius: '20px' }}>
            <img style={{height: '100%', width: '100%', objectFit: 'cover',objectPosition: 'center' }} src={`https://www.themoviedb.org/t/p/original/${detail.poster_path}?api_key=223667d1239871fc4b6eeef8d0d6def8`} alt="" />
            </div>
            <h1 style={{ position: 'absolute', marginLeft: '450px', color: 'white', marginTop: '40px' }}>{detail.original_title}(2023)</h1>
            ...
            <p style={{ position: 'absolute', color: 'white', padding: '0px 450px' }}> <span className={styles.spantag}>Overview</span> <br />{detail.overview}</p>
            
            </div>
            <img className={styles.backimg} src={`https://www.themoviedb.org/t/p/w1920_and_h800_multi_faces/${detail.backdrop_path}?api_key=223667d1239871fc4b6eeef8d0d6def8`} alt="" /> 
            </div>        
